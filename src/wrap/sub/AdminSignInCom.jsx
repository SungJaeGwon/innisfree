...
export default function SignInCom () {    
    ...
    const onSubmitSignIn=(e)=>{
        ...
        axios({
            url: 'http://ab60704.dothome.co.kr/innisfree/innisfree_admin_signIn.php',
            method: 'POST',
            data: formData
        })
        .then((res)=>{
                        ...
                        <ul className="form_box">
                            <li className="login_box">
                                <input 
                                    ...
                                    onChange={onChangeId}
                                />
                                <button className={`del_btn ${state.id_del_btn!=='' ? ' on' : ''}`} type='button'><img src="./images/sub/signIn/icon_smallClose.png" alt="" /></button>
                            </li>
                            <li className="login_box">
                                <input 
                                    type="text" 
                                    ...
                                    onChange={onChangePw}
                                />
                                <button className='del_btn' type='button'><img src="./images/sub/signIn/icon_smallClose.png" alt="" /></button>
                            </li>
